...
/**
 *  Show The debugger toolbar, how to install? 
    Usually in your app's appdelegate add the following.
    #if DEBUG 
    [[FLEXManager sharedManager] showExplorerFromWindow:self.window];
    #endif
 *  
 *  Use two fingers to swipe left to show the tool bar
 *
 *  @param window the window to show
 */
- (void)showExplorerFromWindow:(UIWindow *)window;
